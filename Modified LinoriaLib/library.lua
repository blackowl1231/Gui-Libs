...
function EZ:EnsureFolders()
	...
	ensurefolder(base);
	ensurefolder(base .. '/cache');
	ensurefolder(base .. '/themes');
	ensurefolder(base .. '/' .. self.Game);
	ensurefolder(base .. '/' .. self.Game .. '/config');
end

function EZ:ReadCache()
	local path = self.BaseFolder .. '/cache/autoload.dat'
...
function EZ:WriteCache(data)
	local path = self.BaseFolder .. '/cache/autoload.dat'
	ensurefolder(self.BaseFolder);
	ensurefolder(self.BaseFolder .. '/cache');
